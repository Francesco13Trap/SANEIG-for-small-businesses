...
Both were validated against a local Postgres instance (schema applies
cleanly; a two-tenant smoke test confirmed read/write isolation and the
Commercialista read-only role) before being committed.
