...
import { deleteScadenza } from "@/app/scadenze-attivita/actions";

export function EliminaScadenzaDialog({
  id,
  titolo,
}: {
  id: string;
  ...
  const [state, formAction, pending] = useActionState(deleteScadenza, undefined);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Vuoi eliminare la scadenza &quot;{titolo}&quot;? L&apos;operazione
