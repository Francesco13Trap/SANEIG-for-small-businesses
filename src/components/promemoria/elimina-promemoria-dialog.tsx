...
import { deletePromemoria } from "@/app/promemoria/actions";

export function EliminaPromemoriaDialog({
  id,
  titolo,
}: {
  id: string;
  ...
  const [state, formAction, pending] = useActionState(deletePromemoria, undefined);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Vuoi eliminare il promemoria &quot;{titolo}&quot;?
