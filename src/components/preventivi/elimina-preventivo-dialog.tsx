...
import { deletePreventivo } from "@/app/preventivi/actions";

export function EliminaPreventivoDialog({
  id,
  titolo,
}: {
  id: string;
  ...
  const [state, formAction, pending] = useActionState(deletePreventivo, undefined);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Vuoi eliminare il preventivo &quot;{titolo}&quot;? L&apos;operazione
