...
import { deleteRecensione } from "@/app/recensioni/actions";

export function EliminaRecensioneDialog({
  id,
  cliente,
}: {
  id: string;
  ...
  const [state, formAction, pending] = useActionState(deleteRecensione, undefined);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Vuoi eliminare la recensione di &quot;{cliente}&quot;?
