...
import { deleteStipendio } from "@/app/stipendi/actions";

export function EliminaStipendioDialog({
  id,
  nome,
}: {
  id: string;
  ...
  const [state, formAction, pending] = useActionState(deleteStipendio, undefined);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Vuoi eliminare il promemoria di {nome}? L&apos;operazione non si
            può annullare.
          </DialogDescription>
        </DialogHeader>
