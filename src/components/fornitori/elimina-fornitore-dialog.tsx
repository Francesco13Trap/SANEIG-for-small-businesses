...
import { deleteFornitore } from "@/app/fornitori/actions";

export function EliminaFornitoreDialog({
  id,
  nome,
}: {
  id: string;
  ...
  const [state, formAction, pending] = useActionState(deleteFornitore, undefined);
